...
/* harmony export */   "addTaskToAllFilter": () => (/* binding */ addTaskToAllFilter),
...
function getTaskInformation(selectedProject) {
  ...
  const task = new _task__WEBPACK_IMPORTED_MODULE_9__["default"](
    taskTitle,
    taskDescription,
    taskDate,
    taskPriority,
...
function displayTaskInAllFilter(
  ...
  expandedTaskInfoCellDueDate.appendChild(
    componentExpandedTaskSpan(
      (0,date_fns_format__WEBPACK_IMPORTED_MODULE_10__["default"])(new Date(taskDueDate), 'eeee, MMMM dd, yyyy')
    )
  );
...
function addTaskToAllFilter(task) {
  const tasks = document.querySelector('.tasks');
  tasks.appendChild(
...
function showEditTaskForm(taskToEdit, onsubmit, onCancel) {
  const tasksContainer = document.querySelector('.tasks-card');
...
const secondaryProject = new _project__WEBPACK_IMPORTED_MODULE_2__["default"]('Work', secondaryTasks);
...
sidebar.addEventListener('click', (e) => {
  ...
  if (projectButton) {
    ...
    const allTasks = (0,_site_storage__WEBPACK_IMPORTED_MODULE_3__.getAllTasks)();
    ...
    for (let i = 0; i < allTasks.length; i += 1) {
      (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.addTaskToAllFilter)(allTasks[i]);
    }
