...
/* harmony export */   "addTaskToFilter": () => (/* binding */ addTaskToFilter),
/* harmony export */   "clearAllTaskContent": () => (/* binding */ clearAllTaskContent),
/* harmony export */   "componentEditTaskInputForm": () => (/* binding */ componentEditTaskInputForm),
...
/* harmony export */   "updateTaskInformation": () => (/* binding */ updateTaskInformation)
/* harmony export */ });
...
function componentFormTaskDueDate(taskToEdit) {
  ...
  if (taskToEdit) {
    taskDueDateField.value = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_10__["default"])(taskToEdit.dueDate, 'yyyy-MM-dd');
  }
...
function componentEditTaskSubmit() {
  const taskSubmit = document.createElement('button');
  taskSubmit.setAttribute('type', 'submit');
  taskSubmit.setAttribute('id', 'edit-task-submit');
...
// Update task information after editing task
function updateTaskInformation(taskToEdit) {
...
function componentEditTaskInputForm(taskToEdit) {
  const taskForm = document.createElement('form');
  const taskFormGroup = componentTaskFormGroup();
  const taskNameGroup = componentTaskItemGroup();
  const descriptionGroup = componentTaskItemGroup();
  ...
  taskForm.setAttribute('id', 'edit-task-form');
  taskForm.appendChild(taskFormGroup);
...
function displayTaskInFilter(
  ...
  expandedTaskInfoCellDueDate.appendChild(
    componentExpandedTaskSpan((0,date_fns_format__WEBPACK_IMPORTED_MODULE_10__["default"])(taskDueDate, 'eeee, MMMM dd, yyyy'))
  );
...
function showEditTaskForm(taskToEdit) {
  const tasksContainer = document.querySelector('.tasks-card');
...
/* harmony import */ var date_fns_endOfWeek__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns/endOfWeek */ "./node_modules/date-fns/esm/endOfWeek/index.js");
/* harmony import */ var date_fns_startOfDay__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! date-fns/startOfDay */ "./node_modules/date-fns/esm/startOfDay/index.js");
/* harmony import */ var date_fns_endOfDay__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! date-fns/endOfDay */ "./node_modules/date-fns/esm/endOfDay/index.js");
...
/* harmony import */ var _site_storage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./site-storage */ "./src/site-storage.js");
...
let selectedProject = (0,_site_storage__WEBPACK_IMPORTED_MODULE_2__.getProjects)()[0];
let taskToEdit = '';
let taskId = '';

function createTask() {
  const task = (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.getTaskInformation)(selectedProject);

  // Add task to the selected project's array of tasks
  (0,_site_storage__WEBPACK_IMPORTED_MODULE_2__.addTask)(selectedProject, task);
}
...
function controlDisplay(comingFrom) {
  if (comingFrom === 'task list') {
    ...
    (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.clearAllTaskContent)();
...
(0,_site_storage__WEBPACK_IMPORTED_MODULE_2__.getProjects)().forEach((project) => {
...
projectForm.addEventListener('keypress', (e) => {
  if (e.key === 'Enter') {
    ...
    (0,_site_storage__WEBPACK_IMPORTED_MODULE_2__.addProject)(newProject);
...
sidebar.addEventListener('click', (e) => {
  ...
  const allTasks = (0,_site_storage__WEBPACK_IMPORTED_MODULE_2__.getAllTasks)();
  ...
  if (projectButton) {
    ...
    const projects = (0,_site_storage__WEBPACK_IMPORTED_MODULE_2__.getProjects)();
    ...
    (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.showTasksSection)(onClickOfAddTaskButton);

    // Show the add task button
    (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.showAddTaskButton)();
    ...
    (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.clearAllTaskContent)();
    (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.showTasksSection)(onClickOfAddTaskButton);
    (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.hideAddTaskButton)();
    selectedProject = '';

    for (let i = 0; i < allTasks.length; i += 1) {
      (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.addTaskToFilter)(allTasks[i]);
    }
    ...
    for (let i = 0; i < allTasks.length; i += 1) {
      if (
        (0,date_fns_isWithinInterval__WEBPACK_IMPORTED_MODULE_3__["default"])(allTasks[i].dueDate, {
          start: (0,date_fns_startOfWeek__WEBPACK_IMPORTED_MODULE_4__["default"])(current),
          end: (0,date_fns_endOfWeek__WEBPACK_IMPORTED_MODULE_5__["default"])(current),
        })
      ) {
        (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.addTaskToFilter)(allTasks[i]);
      }
    ...
    for (let i = 0; i < allTasks.length; i += 1) {
      if (
        (0,date_fns_isWithinInterval__WEBPACK_IMPORTED_MODULE_3__["default"])(allTasks[i].dueDate, {
          start: (0,date_fns_startOfDay__WEBPACK_IMPORTED_MODULE_6__["default"])(current),
          end: (0,date_fns_endOfDay__WEBPACK_IMPORTED_MODULE_7__["default"])(current),
        })
      ) {
        (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.addTaskToFilter)(allTasks[i]);
      }
...
taskList.addEventListener('click', (e) => {
  if (e.target.classList.contains('checkbox-label')) {
    ...
    (0,_site_storage__WEBPACK_IMPORTED_MODULE_2__.addAllProjectsToLocalStorage)();
    ...
    (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.showEditTaskForm)(taskToEdit);
...
taskList.addEventListener('submit', (e) => {
  if (e.target.classList.contains('edit-task-form')) {
    ...
    const updatedTask = (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.updateTaskInformation)(taskToEdit);
...
taskList.addEventListener('change', (e) => {
  ...
  if (e.target.checked) {
    (0,_site_storage__WEBPACK_IMPORTED_MODULE_2__.setCompletion)(taskChanged, true);
  } else {
    (0,_site_storage__WEBPACK_IMPORTED_MODULE_2__.setCompletion)(taskChanged, false);
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addAllProjectsToLocalStorage": () => (/* binding */ addAllProjectsToLocalStorage),
/* harmony export */   "addProject": () => (/* binding */ addProject),
/* harmony export */   "addTask": () => (/* binding */ addTask),
/* harmony export */   "getAllProjectsFromLocalStorage": () => (/* binding */ getAllProjectsFromLocalStorage),
/* harmony export */   "getAllTasks": () => (/* binding */ getAllTasks),
/* harmony export */   "getProjects": () => (/* binding */ getProjects),
/* harmony export */   "setCompletion": () => (/* binding */ setCompletion)
/* harmony export */ });
...
/* harmony import */ var date_fns_endOfYear__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns/endOfYear */ "./node_modules/date-fns/esm/endOfYear/index.js");
...
function addAllProjectsToLocalStorage() {
  if (storageAvailable('localStorage')) {
...
if (projects.length === 0) {
  const primaryTasks = [
    new _task__WEBPACK_IMPORTED_MODULE_1__["default"](
      ...
      (0,date_fns_endOfYear__WEBPACK_IMPORTED_MODULE_2__["default"])(current),
      'low',
      'Home'
    ),
    new _task__WEBPACK_IMPORTED_MODULE_1__["default"](
      ...
      (0,date_fns_endOfWeek__WEBPACK_IMPORTED_MODULE_3__["default"])(current),
      'high',
      'Home'
    ),
  ];
  ...
  const secondaryTasks = [
    new _task__WEBPACK_IMPORTED_MODULE_1__["default"](
      ...
      (0,date_fns_endOfDay__WEBPACK_IMPORTED_MODULE_4__["default"])(current),
      'high',
      'Work'
    ),
  ];

  const primaryProject = new _project__WEBPACK_IMPORTED_MODULE_0__["default"]('Home', primaryTasks);
  const secondaryProject = new _project__WEBPACK_IMPORTED_MODULE_0__["default"]('Work', secondaryTasks);
...
function setCompletion(task, completed) {
